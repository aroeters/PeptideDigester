 ...
 * @author arne
 */
public class PepsinDigestorHigherPH implements Digestor {
     ...
     * @param minLength
     */
    public PepsinDigestorHigherPH(final Integer minLength) {
    ...
    public final ArrayList<String> digest(final String peptide) {
        ...
        ArrayList<Character> aa = new ArrayList<>(Arrays.asList('F', 'L', 'W', 'Y'));
