 ...
 * @author arne
 */
public class TrypsinDigestorConservative implements Digestor {
     ...
     * @param minLength
     */
    public TrypsinDigestorConservative(final Integer minLength) {
    ...
    public final ArrayList<String> digest(final String peptide) {
        ...
        ArrayList<Character> aa = new ArrayList<>(Arrays.asList('R', 'K'));
